...
public:
  ...
  inline const Block &GetBlock(int r, int c) const { return m_BlockMap.GetBlock(r, c); }
  inline const Block &GetBlock(const Vector2 &vec) const { return m_BlockMap.GetBlock(vec); }
  ...
  inline const NodePtrSet &GetHeads() const { return m_NodeHeads; }
  inline const NodePtrSet &GetTails() const { return m_NodeTails; }
  inline const NodePtrSet &GetEssentialNodes() const { return m_NodeEssentials; }
  inline const SideSet &GetEssentialSides() const { return m_SideEssentials; }
  inline const SideSet &GetObstacleSides() const { return m_SideObstacles; }
